...
Por esta razón, se agregó un Landing Page que presenta la aplicación antes de ingresar a ella y se incorporó la consulta del estado de la cita, para dar mayor claridad y control a los pacientes.
...
Los pacientes pueden comprender más fácilmente el propósito de la aplicación gracias al Landing Page y ahora pueden consultar el estado de su cita cuando lo necesiten.
...
La cancelación de una cita por parte del paciente todavía no está disponible: hoy sólo la doctora puede rechazarla desde el panel. Es la siguiente función a agregar sobre esta misma base.
